...
namespace Datadog.Trace.ClrProfiler
{
    ...
    internal static class ScopeFactory
    {
        ...
        /// <param name="spanContext">The span context for the scope</param>
        /// <returns>A new pre-populated scope.</returns>
        public static Scope CreateOutboundHttpScope(Tracer tracer, string httpMethod, Uri requestUri, IntegrationInfo integrationId, out HttpTags tags, SpanContext spanContext = null)
        {
            tags = null;
            ...
            try
            {
                ...
                scope = tracer.StartActiveWithTags(OperationName, tags: tags, serviceName: $"{tracer.DefaultServiceName}-{ServiceName}", spanId: spanContext?.SpanId);
                var span = scope.Span;
